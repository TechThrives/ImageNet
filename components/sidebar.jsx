function Sidebar() {
  return (
    <div class="h-screen w-64">
      <div class="flex h-full flex-grow flex-col sticky rounded-br-lg rounded-tr-lg bg-white pt-5 shadow-md">
        <span class="ml-3 mt-2 mb-2 block text-xs font-semibold text-gray-500">
          Analytics
        </span>
